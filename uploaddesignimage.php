...
move_uploaded_file($_FILES["img1"]["tmp_name"],"../Uploaddesignimages/" .time() . '-'.$_FILES["img1"]["name"]);
	  ...
	  <div class="wrapper">
		  ...
		  <div class="form">
				  <form name="insert-form" id="contact-form"  method="POST" enctype="multipart/form-data"> 
                        ...
                        <center>					 
	                      <img src="../Uploaddesignimages/<?php echo htmlentities($result->Image);?>" width="300" height="200" style="border:solid 1px #000" class="input">
